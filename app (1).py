...
<style>
    .stApp {
        background: radial-gradient(ellipse at top, #1a1a3e 0%, #0b0e2e 50%, #05061a 100%);
        color: #e8e8f0;
    }
    h1 {
...
culture = st.radio("Pick a mythology:", CULTURES, horizontal=True, label_visibility="collapsed")
...
if st.button("✨ Tell the story"):
    ...
    st.markdown(f"<div style='background: rgba(74,61,122,0.2); border-left: 3px solid #d4af37; padding: 1rem 1.5rem; border-radius: 4px; font-style: italic;'>{story}</div>", unsafe_allow_html=True)
